...
Basic System Requirements need to be met to upload a CSV with bulk of records. Kindly check your System Requirements by Settings â†’ Security and Performance on CSV Importer plugin settings tab. You have to increase the system requirements values to the minimum values mentioned in the plugin. <br />
...
* Fixed: Text changes
= 5.2 =
* Added: Advance mapping view with Drag â€˜nâ€™ Drop support.
...
* Added: Restriction to show â€œAdmin dashboard widgetâ€ only for users with Admin role. [Solved](https://wordpress.org/support/topic/admin-dashboard-widget-is-showing-to-all-users)
